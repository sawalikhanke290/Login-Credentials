...
<body id="page-top">
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Java-FullStack Developer</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - React.js</p>
		</div>
	</header>
	<!-- Portfolio Section-->
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Developer 2024</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
